...
HD_PWD='D:/Documents/xsvobo1q/PLD/cv4/counter_32bit/counter_32bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rp_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rp_top.tcl -notrace
