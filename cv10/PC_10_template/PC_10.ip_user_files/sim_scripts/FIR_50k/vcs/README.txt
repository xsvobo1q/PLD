...
#
# Generated by export_simulation on Mon Apr 11 08:54:51 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './FIR_50k.sh' script.

./FIR_50k.sh -reset_run
...
./FIR_50k.sh -noclean_files

For more information on the script, please type './FIR_50k.sh -help'.
