...
HD_PWD='D:/Documents/xsvobo1q/PLD/cv10/PC_10_template/PC_10.runs/FIR_50k_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_50k.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIR_50k.tcl
