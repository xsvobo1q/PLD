...
HD_PWD='D:/Documents/PLD/cv9/cv9_ILA/cv9_ILA.runs/ila_pwm_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_pwm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_pwm.tcl
